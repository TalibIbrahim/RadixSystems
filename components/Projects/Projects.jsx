...
function Projects() {
  return (
    <section id="projects" className="section projects-section">
      <Reveal>
        <h2 className="section-heading">Our <span className="gradient-text">Projects</span></h2>
        <p className="section-sub">A showcase of what we've built — shipped, live, and battle-tested.</p>
      </Reveal>
